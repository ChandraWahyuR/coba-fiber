...
var ErrLenPassword = errors.New("kata sandi harus minimal 8 karakter")
var ErrInvalidPassword = errors.New("kata sandi harus terdiri dari setidaknya 1 angka, 1 huruf besar, satu simbol tanda baca, dan 1 huruf kecil")
